...
# Features:
# CPU, RAM, Disk, Network, Process, Threads,
# Open Files Monitoring + Actual Memory Allocation
...
def ProcessScan():
    ...
    for proc in psutil.process_iter():
        try:
            ...
            # 🔥 Actual Memory Allocation Feature
            try:
...
def CreateLog(FolderName):
    ...
    try:
        ...
        with open(FileName, "w") as fobj:
            ...
            fobj.write("Process, Thread, Open Files & Memory Monitoring\n")
            fobj.write(Border + "\n")
            ...
            for info in Data:
                ...
                # 🔥 Actual Memory Allocation Output
                fobj.write("RSS (Actual RAM Used) : %s MB\n" %
                           info.get("rss"))

                fobj.write("VMS (Virtual Memory) : %s MB\n" %
                           info.get("vms"))
...
def main():
    ...
    if len(sys.argv) == 2:
        ...
        if sys.argv[1] in ("--h", "--H"):
            ...
            print("Process, Threads, Open Files & Memory Monitoring.")
